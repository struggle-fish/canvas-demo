<template lang="html">
  <div class="clock">
    <div class="controls" @click="getImageData()">
      <input id='snapshotButton' type='button' value='' v-model="btnValue"/>
    </div>
    <img id='imgEle' class="imgEle"/>
  ...
  export default {
    ...
    methods: {
      ...
      getImageData () {
        ...
        let dataUrl = '';
        if (that.btnValue === 'Take snapshot') {
          dataUrl = that.canvas.toDataURL();
          clearInterval(that.timer);
          imgEle.src = dataUrl;
          imgEle.style.display = 'inline';
          that.canvas.style.display = 'none';
          that.btnValue = 'Return to Canvas';
          console.log(dataUrl);
        } else {
          that.btnValue = 'Take snapshot';
